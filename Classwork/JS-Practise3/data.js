...
// console.log(countries_data.filter((item)=> item.languages.includes('English')));


// region asia ve europe olanlar

// console.log(countries_data.filter((item)=> item.region === 'Asia' || item.region === 'Europe'));

// birdən çox əsas dili olan ölkələr

// console.log(countries_data.filter((item)=>item.languages.length>1));

//bütün ölkə adlari ve qarsisinda paytaxtı

// console.log(countries_data.map((item)=>`${item.capital}, ${item.name}`));
